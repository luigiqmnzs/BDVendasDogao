 ...
 * @author Sir Parish
 */
public class CadastrarClienteUI extends javax.swing.JFrame {

    int contCodigoCliente = 0;
    public CadastrarClienteUI() throws SQLException {
        initComponents();
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        setBounds(0,0,screenSize.width, screenSize.height);
        ClientesDAO dao = new ClientesDAO();
        contCodigoCliente = dao.retornarAI();
        labelCodigo.setText(contCodigoCliente + "");
    }
    ...
    if(tNome.getText().equalsIgnoreCase("") || tNome.getText().equalsIgnoreCase("") || tEndereco.getText().equalsIgnoreCase("") || tTelefone.getText().equalsIgnoreCase("")){
        ...
        try {
            ...
            Logger.getLogger(CadastrarClienteUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    dao.inserir(c);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarClienteUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new CadastrarClienteUI().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(CadastrarClienteUI.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
